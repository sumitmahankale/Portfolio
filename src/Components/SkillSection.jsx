  ...
  const SkillCard = ({ skill }) => (
    <div className="group relative">
      <div className={`
        ...
        shadow-lg hover:shadow-xl transform hover:scale-105 hover:-translate-y-2
        min-h-[140px]
      `}>
        {/* Logo Container */}
      ...
      {/* Hover Glow Effect */}
      <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-400 to-purple-500 opacity-0 group-hover:opacity-20 transition-opacity duration-300 -z-10 blur-xl"></div>
    </div>
  );

  // Floating Background Elements
  const FloatingTech = ({ delay = 0, className = "" }) => (
    <div 
      className={`absolute opacity-5 animate-bounce ${className}`}
      style={{ 
    ...
    >
      <div className="w-16 h-16 bg-gradient-to-br from-blue-400 to-purple-500 rounded-lg transform rotate-45"></div>
    </div>
  );
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center mb-6">
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full relative overflow-hidden">
