...
const ProjectsSection = ({ darkMode }) => {
  ...
  const TechIcon = ({ name, className = "w-4 h-4" }) => {
    const techLogos = {
      ...
      'Express.js': (
        <svg viewBox="0 0 24 24" className={className} fill={darkMode ? "#ffffff" : "#000000"}>
    ...
    return techLogos[name] || <Code className={className} />;
  };

  // Projects data with proper image paths from public folder
  const projects = [
    {
      title: "FindMySpot",
      ...
      liveLink: null,
      backgroundImage: "findmyspot.png", // Update this path to match your actual image
      featured: false
    },
    
    {
      ...
      liveLink: null,
      backgroundImage: "DASHBOARD.jpg", // Update this path to match your actual image
      featured: false
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div
              key={project.title}
              className={`group relative rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:transform hover:scale-105 ${
            ...
            >
                ...
                <div className="flex gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  {project.liveLink && (
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg font-medium hover:scale-105 transition-transform duration-200"
                    >
              ...
              {/* Hover Effect Border */}
              <div className="absolute inset-0 rounded-2xl border-2 border-transparent group-hover:border-gradient-to-r group-hover:from-blue-500 group-hover:to-purple-500 transition-all duration-300" />
            </div>
          ))}
        </div>
